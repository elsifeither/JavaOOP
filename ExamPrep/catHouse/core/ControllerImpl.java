...
public class ControllerImpl implements Controller{
    ...
    public String addCat(String houseName, String catType, String catName, String catBreed, double price) {
        ...
        House house = getHouseByName(houseName);
        boolean checkingShort =  (catType.startsWith("Short") && house.getClass().getSimpleName().startsWith("Short"));
        boolean checkingLong =  (catType.startsWith("Long") && house.getClass().getSimpleName().startsWith("Long"));
        if (checkingShort || checkingLong) {
            house.addCat(cat);
        } else {
